...
const NewsletterForm = ({ title = 'Get notified when I post new content!' }) => {
  ...
  return (
    <div>
      <div className="mb-2 pb-1 text-center text-lg font-semibold text-gray-800 dark:text-gray-100">
        {title}
      </div>
      <form className="flex flex-col sm:flex-row" onSubmit={subscribe}>
        <div>
          ...
          <input
            autoComplete="email"
            className="w-72 rounded-md px-4 focus:border-transparent focus:outline-none focus:ring-2 focus:ring-primary-600 dark:bg-gray-900"
            id="email-input"
            name="email"
